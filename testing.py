...
#app = Flask(__name__)
'''
# TODO Edit google credentials to allow authorization for localhost:8000
CLIENT_ID = json.loads(
    open('client_secret_u.json', 'r').read())['web']['client_id']
APPLICATION_NAME = "Road Map To Health Application"
'''
...
def newMedicine():  # organSystem_id
    return "page to create a new organ system"
...
# , methods=['GET', 'POST']
@app.route('/RoadMapToHealth/RoadMapToHealth/medicine/medicine_id/edit')
